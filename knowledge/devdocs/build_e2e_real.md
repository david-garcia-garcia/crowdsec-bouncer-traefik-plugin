...
- Custom-ban and captcha compose labels set `bouncerBanFilePath` / `bouncerCaptchaFilePath`. Do not use `banHtmlFilePath` / `captchaHtmlFilePath` or HTML-cased twins.
