...
func TestHeaderReasonFromOrigin(t *testing.T) {
	tests := []struct {
		...
		{origin: lapi.OriginPluginTechCacheFail, want: headerReasonCacheFail},
		{origin: lapi.OriginPluginTechGetRemoteFail, want: headerReasonUnparseableRequest},
		{origin: lapi.OriginPluginTechTrustIPFail, want: headerReasonUnparseableRequest},
