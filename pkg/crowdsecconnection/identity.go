...
// Enabled, middleware name, log path, and AppSec failure action are not included.
// DecisionScopeHeaders is included because it changes stream scopes= and ingest.
