...
| --- | --- | --- |
| Branch | 2026-09-06-captcha-handler-hardening not pushed (propose commit pending) | git |
...
| Reviewed head | e1ffcc0 | Pre-propose-commit baseline |
