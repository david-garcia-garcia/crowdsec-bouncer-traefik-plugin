...
- [x] note medium  `knowledge/debt/2026-09-20-active-decisions-ttl-forget.md`
  Why: Peek-then-adjust lives on Store PutMany/DeleteMany only; memory PublishTick expiry and Redis TTL do not decrement.
  Taken: memory recount after PublishTick includes expiry; Redis ActiveCounts is empty.
