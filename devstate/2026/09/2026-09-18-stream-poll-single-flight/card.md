Developer review: in progress — 2026-09-18T06:46:59Z
...
## Merge readiness
Apply is on the branch. Remote CI after the apply push is not measured yet. 2 items remain.

Priority: P1 — production stream health and decision apply are racy on DestBranch today
Reviewed head: 513db38
Owner decision: None.

## Review scores
| Measure | Result | What it means |
| --- | --- | --- |
| Overall readiness | 1/6 | Apply pushed; latest CI not seen |
| CI proof | 1/6 | not seen on reviewed head 513db38 |
...
| CI | not seen | latest apply head not yet measured |
...
Local ticket `2026-09-18-stream-poll-single-flight` is branch and PR #72. Apply is pushed. Waiting for CI on the apply head. Owner merges; this run does not.

## Decision needed
None.

## Before merge
- [ ] Green CI on the apply head, including the new Race detector job
...
| Reviewed head | 513db38cfe92a0a321c039430306223d2f6dcead | Card must match the branch you measured |
