...
- **WHEN** two `New` calls use the same LAPI fields after secret file inlining and CAPI alone-mode rewrite
- **THEN** both reclaim the same LAPI Client
