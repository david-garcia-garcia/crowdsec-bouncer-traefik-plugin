...
- Add the Pester real-stack suite from PR 273: `Test-Integration.ps1`, `docker-compose.test.yml`, `tests/*.Tests.ps1`.
...
- New `Test-Integration.ps1`, `docker-compose.test.yml`, `tests/*.Tests.ps1`, `tests/TestUtils.ps1`.
...
- README testing note for `./Test-Integration.ps1`.
